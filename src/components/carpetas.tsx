...
export function GrillaCarpetas({
  ...
  return (
    ...
    <div className="grid min-h-0 flex-1 gap-4 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)]">
      <ul className="con-barra grid min-h-0 grid-cols-2 content-start gap-3 overflow-y-auto pr-3 sm:grid-cols-3 lg:grid-cols-2">
...
function CuerpoPanel({
  ...
  return (
    ...
    >
      ...
      <div className="con-barra min-h-0 flex-1 overflow-y-auto p-3 pr-4">{carpeta.panel()}</div>
    </div>
  );
}
